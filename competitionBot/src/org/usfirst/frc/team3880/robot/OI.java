...
public class OI {
	...
	public Button buttonR1 = new JoystickButton(joy1, 1), buttonR2 = new JoystickButton(joy1, 2),
			buttonR3 = new JoystickButton(joy1, 3), buttonR4 = new JoystickButton(joy1, 4),
			buttonR5 = new JoystickButton(joy1, 5), buttonR6 = new JoystickButton(joy1, 6),
			buttonR7 = new JoystickButton(joy1, 7), buttonR8 = new JoystickButton(joy1, 8),
			buttonR9 = new JoystickButton(joy1, 9), buttonR10 = new JoystickButton(joy1, 10),
			buttonR11 = new JoystickButton(joy1, 11), buttonR12 = new JoystickButton(joy1, 12);

	public Joystick joy2 = new Joystick(1);
	public Button buttonL1 = new JoystickButton(joy2, 1), buttonL2 = new JoystickButton(joy2, 2),
			buttonL3 = new JoystickButton(joy2, 3), buttonL4 = new JoystickButton(joy2, 4),
			buttonL5 = new JoystickButton(joy2, 5), buttonL6 = new JoystickButton(joy2, 6),
			buttonL7 = new JoystickButton(joy2, 7), buttonL8 = new JoystickButton(joy2, 8),
			buttonL9 = new JoystickButton(joy2, 9), buttonL10 = new JoystickButton(joy2, 10),
			buttonL11 = new JoystickButton(joy2, 11), buttonL12 = new JoystickButton(joy2, 12);

	public static Joystick xbox = new Joystick(2);
	public Button AButton = new JoystickButton(xbox, 1), BButton = new JoystickButton(xbox, 2),
			XButton = new JoystickButton(xbox, 3), YButton = new JoystickButton(xbox, 4),
			leftButton = new JoystickButton(xbox, 5), rightButton = new JoystickButton(xbox, 6),
			selectButton = new JoystickButton(xbox, 7), startButton = new JoystickButton(xbox, 8),
