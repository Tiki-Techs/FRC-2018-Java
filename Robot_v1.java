...
public class Robot_v1 extends IterativeRobot{
	...
	public Command print(String print) {
...
//		button1.whenPressed(print("motorYas"));
...
/**		victorZero.set(m_stick.getY() - m_stick.getX());
		victorOne.set(m_stick.getY() - m_stick.getX());
		victorTwo.set(m_stick.getY() + m_stick.getX());
		victorThree.set(m_stick.getY() + m_stick.getX()); **/
	}
